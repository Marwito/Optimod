...
import model.computer.tsp.TSP3;
/**
 * Test de la class TSP3
 * @author Adrien (je suis dislexique excuser les fotes d'ortographe)
 *
 */
public class TestTsp3 {
	...
	public void costTest(){
		...
		try {
			...
			Method method;
			method = TSP3.class.getDeclaredMethod("coutSuivant", classes);
	...
	public void boundTest(){
		TSP tsp = new TSP3();
		int infinite = Computer.Infinite;
		int costs[][] = { 	{ infinite, 5, 			1, 			10, 		infinite 	},
							{ 4, 		infinite, 	3, 			infinite, 	8 			},
							{ 4, 		infinite, 	infinite, 	8, 			infinite 	}, 
							{ infinite, infinite, 	2, 			infinite, 	3 			},
							{ infinite, infinite, 	1, 			4, 			infinite 	} };
		int durations[] = { 2, 7, 4, 0, 0 };
		...
		try {
			...
			Method method;
			method = TSP3.class.getDeclaredMethod("bound", classes);
			method.setAccessible(true);
	...
	public void boundTest2(){
		...
		try {
			...
			Object[] args1 = {1,aVoir,costs,durations};
			double result = (double) method.invoke(tsp, args1);
			assertEquals(41.0, result , 0.00001);
