...
public class TestTsp4 {
	...
	public void costTest(){
		...
		try {
			...
			Method method;
			method = TSP4.class.getDeclaredMethod("coutSuivant", classes);
	...
	public void boundTest(){
		...
		try {
			...
			Method method;
			method = TSP4.class.getDeclaredMethod("bound", classes);
			method.setAccessible(true);
	...
	public void boundTest2(){
		...
		try {
			...
			Object[] args1 = {1,aVoir,costs,durations};
			double result = (double) method.invoke(tsp, args1);
			assertEquals(33.5, result , 0.00001); //TODO verifier si c'est bon. 
