...
import model.computer.tsp.TSP2;
/**
 * Test de la class TSP2
 * @author Adrien (je suis dislexique excuser les fotes d'ortographe)
 *
 */
public class TestTsp2 {
	...
	public void costTest(){
		...
		try {
			...
			Class [] classes = {Integer.class , Integer.class ,int.class , int[][].class , int[].class , int[].class  ,int[].class };
			Method method;
			method = TSP2.class.getDeclaredMethod("coutSuivant", classes);
			method.setAccessible(true);
			
			//if the time of arrival and the time of departure is in the time window
	...
	public void costTest2(){
		...
		int endWindow[] = {Integer.MAX_VALUE,Integer.MAX_VALUE,Integer.MAX_VALUE,Integer.MAX_VALUE,Integer.MAX_VALUE};
	...
	public void ChercheSolutionPerformanceTest() {
		...
		tsp.chercheSolution(10000, durations.length, costs, durations,biginWindow,endWindow);
		System.out.println(tsp.getNbappel());
	...
	public void ChercheSolutionPerformanceTest2() {
		...
		assertEquals(0, (int) tsp.getMeilleureSolution(0));
		assertEquals(10, (int) tsp.getMeilleureSolution(1));
		assertEquals(9, (int) tsp.getMeilleureSolution(2));
		assertEquals(4, (int) tsp.getMeilleureSolution(3));
		assertEquals(2, (int) tsp.getMeilleureSolution(4));
		assertEquals(1, (int) tsp.getMeilleureSolution(5));
		assertEquals(3, (int) tsp.getMeilleureSolution(6));
		assertEquals(5, (int) tsp.getMeilleureSolution(7));
		assertEquals(6, (int) tsp.getMeilleureSolution(8));
		assertEquals(7, (int) tsp.getMeilleureSolution(9));
		assertEquals(8, (int) tsp.getMeilleureSolution(10));
